...
#---------------------------------------------------------------------------------------------------#
#----Show monthly seasonal cycle for each station: clear Seasonality for all stations direction_1----
#---------------------------------------------------------------------------------------------------#
# All stations
df_cycling %>% 
  ...
  geom_line() +
  ggtitle("All stations: Mean cyclists for each day across the years, direction_1") +
  xlab("date")+
...
df_cycling %>% 
  ...
  ggplot(aes(x = date_dm, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Hirsch: Mean cyclists for each day across the years, direction_1") +
  xlab("date")+
  scale_x_date(date_breaks = "months", date_labels = "%b", expand = c(0, 0))

#---------------------------------------------------------------------------------------------------#
#----Show monthly seasonal cycle for each station: clear Seasonality for all stations direction_2----
#---------------------------------------------------------------------------------------------------#
# All stations
df_cycling %>% 
  mutate(date_dm = format(date, format = "%m-%d")) %>% 
  ...
  ggplot(aes(x = date_dm, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("All stations: Mean cyclists for each day across the years, direction_2") +
  xlab("date")+
  scale_x_date(date_breaks = "months", date_labels = "%b", expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = date_dm, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Olympia: Mean cyclists for each day across the years, direction_2") +
  xlab("date")+
  scale_x_date(date_breaks = "months", date_labels = "%b", expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = date_dm, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Kreuther: Mean cyclists for each day across the years, direction_2") +
  xlab("date")+
  scale_x_date(date_breaks = "months", date_labels = "%b", expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = date_dm, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Margareten: Mean cyclists for each day across the years, direction_2") +
  xlab("date")+
  scale_x_date(date_breaks = "months", date_labels = "%b", expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = date_dm, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Hirsch: Mean cyclists for each day across the years, direction_2") +
  xlab("date")+
  scale_x_date(date_breaks = "months", date_labels = "%b", expand = c(0, 0))
...
df_cycling %>%     
  ...
  ggplot(aes(x = hour, y = weekday, fill = mean_cyclists)) +
  geom_tile() +
...
df_mean_cyclists_per_day_weekday <- 
  df_cycling %>%
...
df_mean_cyclists_per_day_weekend <- 
  df_cycling %>%
...
ggplot() +
  ...
  ggtitle("All stations: number of cyclists per hour of the day, direction_1") +
  xlab("hour") +
  ylab("cyclists") +
...
ggplot() +
  ...
  ggtitle("All stations: number of cyclists per hour of the day, direction_2") +
  xlab("hour") +
  ylab("cyclists") +
  scale_color_manual(name = "", values = c("weekday" = "blue", "weekend" = "red")) +
  theme_light() +
...
df_cycling %>% 
  ...
  geom_line() +
  ggtitle("All stations: Time series, direction_1") +
  xlab("date") +
  theme_light() +
...
ggplot() +
  ...
  ggtitle("All stations: Yearly averaged cyclists, direction_1") +
  xlab("date") +
  theme_light() +
  scale_x_continuous(breaks = scales::breaks_width(1), expand = c(0, 0)) 
...
ggplot() +
  ...
  summarise(mean_cyclists_per_day = mean(direction_2, na.rm=T)) %>% 
  geom_line(mapping = aes(x = year, y = mean_cyclists_per_day, color = "All stations")) +
  ggtitle("All stations: Yearly averaged cyclists, direction_2") +
  xlab("date") +
  theme_light() +
  scale_x_continuous(breaks = scales::breaks_width(1), expand = c(0, 0)) 

#--------------------------------------#
#----Weekly seasonality; direction_1----
#--------------------------------------#
# All stations
df_cycling %>% 
  ...
  geom_line() +
  ggtitle("All stations: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Arnulf: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Kreuther: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Olympia: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Hirsch: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Margareten: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Erhardt: Mean cyclists for hour_weekday, direction_1") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
#--------------------------------------#
#----Weekly seasonality; direction_2----
#--------------------------------------#
# All stations
df_cycling %>% 
  select(hour_weekday, direction_2) %>% 
  group_by(hour_weekday) %>% 
  summarise(mean_cyclists_per_day = mean(direction_2, na.rm = T)) %>% 
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("All stations: Mean cyclists for hour_weekday, direction_2") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Arnulf: Mean cyclists for hour_weekday, direction_2") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Kreuther: Mean cyclists for hour_weekday, direction_2") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Olympia: Mean cyclists for hour_weekday, direction_2") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Hirsch: Mean cyclists for hour_weekday, direction_2") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
...
df_cycling %>% 
  ...
  ggplot(aes(x = hour_weekday, y = mean_cyclists_per_day)) +
  geom_line() +
  ggtitle("Margareten: Mean cyclists for hour_weekday, direction_2") +
  xlab("hour_weekday") +
  theme_light() +
  geom_vline(xintercept = seq(0, 167, by = 24), linetype = "dashed", color = "red") +
  scale_x_continuous(breaks = seq(0, 167, by = 24), expand = c(0, 0))
